---
description: Provide instructions for exporting the HTML report to PDF
---
...
Determine the current quarter, then display:
...
Need to generate a report first? Run /qc-report
```
