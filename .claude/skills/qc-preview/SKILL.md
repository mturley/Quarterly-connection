---
description: "Fetch and display all raw data that would go into a report — without generating the report. Usage: /qc-preview or /qc-preview Q4 2025"
---
...
If user specified (e.g., `/qc-preview Q4 2025`), use that instead.
...
See `.claude/skills/qc-report/SKILL.md` Step 2 for exact query format.
...
Ready to generate the full report? Say "/qc-report" to continue.
```
