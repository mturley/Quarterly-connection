---
description: Initialize or update the Quarterly Connection configuration (company, profile, GitHub, Jira)
---
...
Try these next:
   /qc-log    — Add your first achievement
   /qc-status — See current quarter info
